...
def initial_UI_MainWindow(self):
    ...
    scaled_pixmap = original_pixmap.scaled(
        self.Uic.CameraFrame2.size(), Qt.KeepAspectRatio, Qt.SmoothTransformation
    )
...
def set_error_camera_state(self):
    ...
    self.Uic.CameraFrame1.setPixmap(scaled_pixmap)
    scaled_pixmap2 = original_pixmap.scaled(
        self.Uic.CameraFrame2.size(), Qt.KeepAspectRatio, Qt.SmoothTransformation
    )
    self.Uic.CameraFrame2.setPixmap(scaled_pixmap2)
