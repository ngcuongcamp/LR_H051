...
def read_config(self):
    ...
    self.MES_INPUT_AUTO_ID = config["MES"]["MES_INPUT_AUTO_ID"]
    self.MES_RESULT_AUTO_ID = config["MES"]["MES_RESULT_AUTO_ID"]
    self.MES_BACKEND = config["MES"]["BACKEND"]
    self.SIGNAL_ERRORS = json.loads(config["MES"]["SIGNAL_ERRORS"])
    self.SIGNAL_SUCCESS = json.loads(config["MES"]["SIGNAL_SUCCESS"])
